...
/* Setup Layout Part - Quick Sidebar - disabled for now 1/14 */
...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
    ...
    .state('windows', {
        ...
        data: {
            pageTitle: 'Windows Documentation'
        },
        ...
        resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    name: 'MetronicApp',
                    files: [
                            'js/controllers/WindowsController.js'
                        ]
                    }]);
                }]
        }
    ...
    .state('application', {
        ...
        data: {
            pageTitle: 'Application Documentation'
        },
        controller: "GeneralPageController",
        resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
